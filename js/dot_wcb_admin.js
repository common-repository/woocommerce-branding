    ...
    $( function() {
        $.fn.dot_wcb = function( options ) {
            ...
            $( options.button ).click( function() {
                ...
                tb_show( 'Upload a logo', 'media-upload.php?referer=dot_wcb&type=image&TB_iframe=true&post_id=0', false );
        ...
        // Usage
        $( '.upload' ).dot_wcb(); // Use as default option.
    } );
} ( jQuery ) );